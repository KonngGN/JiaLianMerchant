package com.example.apple.jialianmerchant.zxing;
...
import com.example.apple.jialianmerchant.zxing.camera.CameraManager;
import com.example.apple.jialianmerchant.zxing.decoding.CaptureActivityHandler;
import com.example.apple.jialianmerchant.zxing.decoding.InactivityTimer;
import com.example.apple.jialianmerchant.zxing.view.RGBLuminanceSource;
import com.example.apple.jialianmerchant.zxing.view.ViewfinderView;
...
//        PermissionGen.needPermission(CaptureActivity.this, 100,
//                new String[]{
...
//            ToastUtils.shortToast(resultString);
...
//                            Toast.makeText(getApplicationContext(), resultImage, Toast.LENGTH_SHORT).show();
